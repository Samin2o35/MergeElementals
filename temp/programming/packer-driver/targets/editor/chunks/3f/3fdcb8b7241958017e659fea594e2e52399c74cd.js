    ...
    execute: function () {
      ...
      _export("Launcher", Launcher = (_dec = ccclass('Launcher'), _dec2 = property(Node), _dec3 = property(Camera), _dec4 = property(Node), _dec5 = property({
        ...
        start() {
          ...
          this.computeBounds();
          const area = (_this$inputArea = this.inputArea) != null ? _this$inputArea : this.node;
        ...
        onDestroy() {
          ...
          const area = (_this$inputArea2 = this.inputArea) != null ? _this$inputArea2 : this.node;
        ...
        computeBounds() {
          ...
          const ref = (_this$boundsNode = this.boundsNode) != null ? _this$boundsNode : this.inputArea;
...
//# sourceMappingURL=3fdcb8b7241958017e659fea594e2e52399c74cd.js.map