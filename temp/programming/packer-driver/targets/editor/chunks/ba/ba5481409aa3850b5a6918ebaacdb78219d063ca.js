        ...
        setResponsivePosition() {
          ...
          if (isSameRatio) {
            ...
            if (canvasAspect > designAspect) {
              ...
              const marginOffset = padding / scaleFactor;
              if (this.m_widget.isAlignTop) this.m_widget.top = this.m_originalTop - marginOffset;
              if (this.m_widget.isAlignBottom) this.m_widget.bottom = this.m_originalBottom - marginOffset; // Reset horizontal margins
...
//# sourceMappingURL=ba5481409aa3850b5a6918ebaacdb78219d063ca.js.map