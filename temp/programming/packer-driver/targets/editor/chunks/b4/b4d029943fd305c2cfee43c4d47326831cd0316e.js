    ...
    execute: function () {
      ...
      _export("GlobalAudioManager", GlobalAudioManager = (_dec = ccclass('GlobalAudioManager'), _dec(_class = (_class2 = class GlobalAudioManager extends Component {
        ...
        stop(audioContent) {
          ...
          const source = this._audioSources.find(s => s && s.clip && s.clip.uuid === audioContent.AudioClip.uuid);
...
//# sourceMappingURL=b4d029943fd305c2cfee43c4d47326831cd0316e.js.map