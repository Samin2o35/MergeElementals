  ...
  return {
    ...
    execute: function () {
      ...
      _export("ClickRedirect", ClickRedirect = (_dec = ccclass('ClickRedirect'), _dec2 = property(CCString), _dec3 = property(CCString), _dec(_class = (_class2 = class ClickRedirect extends Component {
        ...
        onClick() {
          var isIOS = /iPhone|iPad|iPod/i.test(navigator.userAgent) || navigator.userAgent.includes("Macintosh");
          var isAndroid = /Android/i.test(navigator.userAgent);
          var appStoreURL = this.IosLink;
          var playStoreURL = this.PlayStoreLink;
          var targetURL = isIOS ? appStoreURL : playStoreURL;
...
//# sourceMappingURL=d462213887cf5fa00c90348cc8d74beb3f0ed029.js.map