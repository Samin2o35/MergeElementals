    ...
    execute: function () {
      ...
      _export("MergeEffect", MergeEffect = (_dec = ccclass('MergeEffect'), _dec2 = property({
        ...
        play(colors) {
          ...
          if (colors === void 0) {
            colors = MergeEffect.DEFAULT_COLORS;
          }

          var accent = (_colors$ = colors[0]) != null ? _colors$ : MergeEffect.GOLD;
          this.spawnFlash();
          this.spawnRing(accent);

          for (var i = 0; i < this.sparkleCount; i++) {
            var baseAngle = i / this.sparkleCount * Math.PI * 2;
            var jitter = (Math.random() - 0.5) * 0.4;
            var col = i % 2 === 0 ? MergeEffect.WHITE : accent;
        ...
        spawnSparkle(angle, color) {
          ...
          var dist = this.sparkleDistance * (0.7 + Math.random() * 0.5);
...
//# sourceMappingURL=14ad2ac7c883cd86b2adacfdf70945b50a6d3788.js.map